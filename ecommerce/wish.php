...
<body>
	...
	<div class="main_wrapper">
		...
		<?php
		//the following is from functions.php total_price() method
		$total = 0;
		global $con; 
		$ip = getIp(); 
		$sel_price = "select * from wish where ip_add='$ip'";
		...
		?>
				...
				<tr align="center">
				<!--remove[] is an array, echo product_id corresponding-->
	...
	function updatecart(){
		...
		if(isset($_POST['update_cart'])){
			...
			$delete_product = "delete from wish where p_id='$remove_id' AND ip_add='$ip'";
